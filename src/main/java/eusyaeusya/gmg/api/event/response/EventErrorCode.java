...
public enum EventErrorCode implements ErrorCode {
    ...
    INVALID_DATE_RANGE("EVE-0200", "시작 날짜는 종료 날짜보다 이전이어야 합니다"),
    INVALID_TIME_RANGE("EVE-0201", "시작 시간은 종료 시간보다 이전이어야 합니다"),
    DATE_RANGE_TOO_LONG("EVE-0202", "날짜 범위는 최대 31일을 초과할 수 없습니다");
